...
const projectsData: Record<string, {
  ...
  'wardha-business-center': {
    ...
    category: 'Residential',
    description: 'A testament to modern architecture. A stylish G+1 modern Indian bungalow elevation featuring a clean, contemporary façade with a balanced mix of textures such as stone cladding, glass railings, and wooden accents.',
    location: 'Nagpur-440022, MH',
    year: '2023',
    area: '2,200 sq.ft (204 sq.mt)',
    image: projectCommercial1,
    details: [
      'Contemporary façade with stone cladding',
      'Glass railings and wooden accents',
      'Large windows for natural light',
      'Sleek balcony on the first floor',
      'Subtle color palette for curb appeal',
      'Modern functionality with elegance',
    ],
  },
  'sunrise-apartments': {
