...
const HeroSection = () => {
  ...
  const {
    displayText
  } = useTypewriter('Professional construction & design services in Wardha. With 15+ years of experience, we transform your vision into reality with quality craftsmanship and honest work.', 1.0, 30);
